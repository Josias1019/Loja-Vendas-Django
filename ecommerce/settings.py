...
SECRET_KEY = 'django-insecure-0g+s#@h1i1d&$a*_q_99zc^pa)%@_7ewy)6^@u5nrp4gb#%@r9'
...
# EDITOR DE TEXTO DE DESCRIÇÃO
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

CKEDITOR_5_CONFIGS = {
    'default': {
        'toolbar': ['heading', '|', 'bold', 'italic', '|', 'fontColor', 'fontBackgroundColor', '|','link', 'bulletedList', 'numberedList', 'blockQuote'],
    ...
    'extends': {
        'toolbar': ['heading', '|', 'bold', 'italic', '|', 'fontColor', 'fontBackgroundColor', '|', 'link', 'bulletedList', 'numberedList', 'blockQuote', 'undo', 'redo'],
        'removePlugins': ["CKBox", "CKFinder", "EasyImage", "RealTimeCollaborativeComments", "RealTimeCollaborativeTrackChanges", "RealTimeCollaborativeRevisionHistory", "PresenceList", "Comments", "TrackChanges", "RevisionHistory", "Pagination", "WProofreader", "SourceEditing"],
    }
}
